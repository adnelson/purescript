...
data ModuleIdentifier = ModuleIdentifier String ModuleType deriving (Show, Eq, Ord, Generic)
instance ToJSON ModuleIdentifier
instance FromJSON ModuleIdentifier
